...
pub mod amyuni_idd {
    ...
    // 2. Andy may crash and restart, but the virtual displays are kept.
    //
    ...
    //             if there're no virtual displays managed by Andy.
    pub fn plug_out_monitor(index: i32, force_all: bool, force_one: bool) -> ResultType<()> {
        ...
        //
        // 1. Andy plug in 2 virtual displays. (Andy)
        // 2. Other process plug out all virtual displays. (User mannually)
        // 3. Other process plug in 1 virtual display. (User mannually)
        // 4. Andy plug out all virtual displays in this call. (Andy disconnect)
        //
        // This is not a normal scenario, Andy will plug out virtual display unexpectedly.
