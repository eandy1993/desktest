...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("Andy".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["yy.it-520.com"];  //服务器 20241205
pub const PUBLIC_RS_PUB_KEY: &str = "kdM9lw8GtY8+Om1dwuS9z2PTsUZuMTRrRngePIqOqx0=";  //key  20241205
